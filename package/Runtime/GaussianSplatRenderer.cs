...
namespace GaussianSplatting.Runtime
{
    ...
    public class GaussianSplatRenderer : MonoBehaviour
    {
        ...
        // 請在 GaussianSplatRenderer.cs 裡面找到這個函式並替換它
        ...
        internal void SetAssetDataOnMaterial(MaterialPropertyBlock mat)
        {
            ...
            // =========================================================
            // [修正開始] GSEffects 邏輯：加入重置與開關
            // =========================================================
            if (m_GSEffects != null)
            {
                // 1. 如果有特效：傳送開關訊號 (1) 與貼圖
                // 注意：這裡假設您的 Shader 用 _ShaderMode 來判斷
                // 如果您 Shader 變數改名了，請確認 Props.ShaderModeID 對應的名稱是否正確
                mat.SetInteger(Props.ShaderModeID, 1); 
            ...
            {
                // 2. 如果沒特效 (None)：強制切換回原始模式 (0)
                // 這行非常重要，沒有這行，拿掉特效後畫面不會變回來
                mat.SetInteger(Props.ShaderModeID, 0);
            }
            // =========================================================
            // [修正結束]
            // =========================================================
